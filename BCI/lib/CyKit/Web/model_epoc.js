    ...
    if (manualControl) {
        ...
        for (arr_element in sensorNAME['epoc']) {
            ...
            if (c.checked == true) {
                ...
                //drawdot(select_contact, inc_y_offset, cy_x, value_floor - ((value_data * .128) *- (2 +
                // eeg_resolution)) * eeg_resolution, myColor);
                drawdot(arr_element, inc_y_offset, cy_x, (value_floor - (value_data * .51) * -(eeg_resolution)),
                    myColor);
