    ...
    if (manualControl) {
        ...
        for (arr_element in sensorNAME['insight']) {
            ...
            if (c.checked == true) {
                ...
                drawdot(arr_element, inc_y_offset, cy_x, (value_floor - (value_data)) * eeg_resolution * 2 + 50,
                    myColor);
        ...
        if (current_tab == "Gyro") {
            ...
            for (i = 7; i < 10; i++) {
                ...
                var gyro_value1 = (((baseline[gyroDATA['insight'][(i * 2) - 2]]) -
                    (contact[gyroDATA['insight'][(i * 2) - 2]])) * 15);
